...
function TeachersListPage() {
    ...
    const { data, error } = useApi(endpoints.teacherlist);
        ...
        <>
            ...
            <div className='breadcrumb-area'>
                <Breadcrumb>
                    ...
                    <Breadcrumb.Item active>Teachers List</Breadcrumb.Item>
                </Breadcrumb>
            </div>
            <section>
            ...
            <section>
                <div className='latest-update-area'>
                    <Container>
                        <ScrollAnimation animateIn="fadeInUp" animateOnce={true} delay={400}>
                            {/* <div className='sub'>Teachers List</div> */}

                        </ScrollAnimation>
                        <ScrollAnimation animateIn="fadeInUp" animateOnce={true} delay={400}>
                            <h2>Our Teacher Team</h2>
                    ...
                    <div className='image-area'>
                        <ul className='photo-list'>
                            <li className='outer-small'>
                                <div className='photo'>
                                    <img src={data.teacher_team[4].image} alt="logo" />
                                </div>
                            </li>
                            <li className='outer-small-2'>
                                <div className='photo'>
                                    <img src={data.teacher_team[3].image} alt="logo" />
                                </div>
                                <div className='photo small'>
                                    <img src={data.teacher_team[2].image} alt="logo" />
                                </div>
                            </li>
                            ...
                            <li className='outer-small-4'>
                                <div className='photo small'>
                                    <img src={data.teacher_team[1].image} alt="logo" />
                                </div>
                                <div className='photo'>
                                    <img src={data.teacher_team[0].image} alt="logo" />
                                </div>
                            </li>
                            <li className='outer-small'>
                                <div className='photo'>
