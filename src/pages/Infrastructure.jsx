...
function InfrastructurePage() {
    ...
    const { data, error } = useApi(endpoints.infrastructure);
        ...
        <>
            ...
            <div className='breadcrumb-area'>
                <Breadcrumb>
                    ...
                    <Breadcrumb.Item active>Infrastructure</Breadcrumb.Item>
                </Breadcrumb>
            </div>
            <section>
                ...
                <div className='about-school-block'>
                    <Container>
                        <Swiper
                            ...
                            className="mySwiper"
                        >
                            {data.school_building.map((item, index) => (
                                <SwiperSlide>
                                    <div className='inner-flex'>
                                        <div className='content'>
                                            ...
                                            <div className='bottom'>
                                                ...
                                                {/* <Link to="about" className='btn-more'>Know more</Link> */}
                                            </div>
                                        </div>
